...
try {
  ...
  // Connetti agli emulatori in sviluppo se disponibili
  if (process.env.NODE_ENV === 'development') {
    try {
      // Controlla se gli emulatori sono già connessi
      ...
      // Gli emulatori potrebbero non essere disponibili, continua senza
  ...
  // Imposta valori di fallback per evitare errori
  app = null;
  auth = null;
  db = null;
}
